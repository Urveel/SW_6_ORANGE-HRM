...
public class UserTest {
    ...
    public void enterLoginUsername() {new LoginPage().setEnterUserName("XYZ");
    }

    @And("Enter login Password")
    public void enterLoginPassword() {new LoginPage().setEnterPassword("1234");
    }

    @And("Click on login button")
    public void clickOnLoginButton() {new LoginPage().clickOnLoginButton();
    }

    @And("Click On Admin")
    public void clickOnAdmin() {new AdminPage().clickOnAdminButton();
    }
    ...
    public void clickOnAddButton() {new AdminPage().clickOnAddButton();
    }

    @And("Verify Text for {string}")
    public void verifyTextForAddUser() {new AddUserPage().setSelectUserRole();
    }
